...
// Function for clustering clothing items based on attributes
function clusterOutfits(clothingItems, numClusters = 3) {
    ...
    // If features are the same - handling
...
function getOutfitRecommendation(clothingItems, weatherSuitability) {
    console.log("Raw clothing items:", clothingItems); // Log raw clothing items
